...
const TEXTOS = {
  'pt-BR': {
    ...
    endereco_fotos_titulo: 'Fotos Ambiente e Fachada',
    ...
    meusAgendamentos_semHistorico: 'Nenhum agendamento passado encontrado.',
    meusAgendamentos_statusAgendado: 'Agendado',
    meusAgendamentos_statusConfirmado: 'Confirmado',
    meusAgendamentos_statusRealizado: 'Realizado',
    meusAgendamentos_statusCancelado: 'Cancelado',
    meusAgendamentos_statusNaoCompareceu: 'Não compareceu',
    ...
    fidelidade_telefone_placeholder: 'Seu telefone cadastrado',
    ...
    modal_promocao_aplicada: 'Promoção aplicada: {nome}',
    modal_promocao_agendarAgora: 'Agendar agora',
  ...
  en: {
    ...
    endereco_fotos_titulo: 'Photos & Facade',
    ...
    meusAgendamentos_semHistorico: 'No past appointments found.',
    meusAgendamentos_statusAgendado: 'Scheduled',
    meusAgendamentos_statusConfirmado: 'Confirmed',
    meusAgendamentos_statusRealizado: 'Completed',
    meusAgendamentos_statusCancelado: 'Cancelled',
    meusAgendamentos_statusNaoCompareceu: 'No-show',
    ...
    fidelidade_telefone_placeholder: 'Your registered phone number',
    ...
    modal_promocao_aplicada: 'Promotion applied: {nome}',
    modal_promocao_agendarAgora: 'Book now',
  ...
  ja: {
    ...
    endereco_fotos_titulo: '店内・外観の写真',
    ...
    meusAgendamentos_semHistorico: '過去の予約は見つかりませんでした。',
    meusAgendamentos_statusAgendado: '予約済み',
    meusAgendamentos_statusConfirmado: '確定済み',
    meusAgendamentos_statusRealizado: '完了',
    meusAgendamentos_statusCancelado: 'キャンセル済み',
    meusAgendamentos_statusNaoCompareceu: '無断キャンセル',
    ...
    fidelidade_telefone_placeholder: '登録済みの電話番号',
    ...
    modal_promocao_aplicada: '適用中のプロモーション: {nome}',
    modal_promocao_agendarAgora: '今すぐ予約する',
  ...
  es: {
    ...
    endereco_fotos_titulo: 'Fotos del Local y Fachada',
    ...
    meusAgendamentos_semHistorico: 'No se encontraron turnos pasados.',
    meusAgendamentos_statusAgendado: 'Agendado',
    meusAgendamentos_statusConfirmado: 'Confirmado',
    meusAgendamentos_statusRealizado: 'Realizado',
    meusAgendamentos_statusCancelado: 'Cancelado',
    meusAgendamentos_statusNaoCompareceu: 'No asistió',
    ...
    fidelidade_telefone_placeholder: 'Tu teléfono registrado',
    fidelidade_consultar_botao: 'Consultar',
    ...
    modal_promocao_aplicada: 'Promoción aplicada: {nome}',
    modal_promocao_agendarAgora: 'Reservar ahora',
